                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <div class="row col-sm-10 justify-content-center mt-8">
                                    <form id="demo-form" method="POST" action="<?= base_url('prosesUploadSOP');?>" enctype="multipart/form-data">
                                        <div class="container">
                                            <div class="row">
                                                <label for="kd_berkas">Kode Document * :</label>
                                                <input type="text" id="kd_sop" class="form-control" name="kd_sop" value="<?= $kd_sop?>" readonly/>

                                                <label for="judul_berkas">Nomor Document * :</label>
                                                <input type="text" id="no_sop" class="form-control" name="no_sop" required/>

                                                <label for="judul_berkas">Nama Document * :</label>
                                                <input type="text" id="judul_sop" class="form-control" name="judul_sop" required/>

                                                <label for="berkas">Berkas * :</label>
                                                <input type="file" id="berkas" class="form-control" name="berkas" required />

                                                <label for="keterangan_sop">Keterangan * :</label>
                                                <textarea id="keterangan_sop" required="required" class="form-control" name="keterangan_sop"></textarea>
                                            </div>
                                        </div>
