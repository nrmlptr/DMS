     ...
     <div class="content">
         ...
         <div class="block">
             <div class="block-header block-header-default">
                 <h3 class="block-title">Document IAD K3 & Lingkungan<small></small></h3>
             </div>
                 ...
                 <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                     ...
                     <tbody>
                         <?php
							...
							foreach ($berkas_iad->result() as $row) { ?>
                         <tr>
                             <td class="d-none d-sm-table-cell"><?= $loop++ ?></td>
                             <td class="d-none d-sm-table-cell"><?= $row->kd_berkas_iad ?></td>
                             <td class="d-none d-sm-table-cell"><?= $row->no_berkas_iad ?></td>
                             <td class="d-none d-sm-table-cell"><?= $row->judul_berkas_iad ?></td>
                             <td class="d-none d-sm-table-cell"><?= $row->keterangan_berkas_iad ?></td>
                             <td class="d-none d-sm-table-cell" align="center">
                                 <a href="<?= base_url('Unggah/downloadIAD/' . $row->id_iad) ?>" class="btn btn-success"
                                     title="Download Document">
                                     <i class="fa fa-download"></i>
                                 </a>
                                 <a href="<?= base_url('Unggah/deleteIADById/' . $row->id_iad) ?>"
