		...
		<div class="block">
			...
			<div class="block-content block-content-full">
				...
				<div class="form-group row">
					<div class="col-12">
						<label for="fileLisensi">File</label>
						<div class="form-material floating">
							<input type="file" class="form-control" id="fileLisensi" name="fileLisensi">
						</div>
					</div>
					...
					<div class="col-12">
						<button type="button" class="btn btn-alt-primary" id="loadLisensi">Load</button>
					</div>
					<!-- create whitespace -->
					<div class="col-12">
						<br>
					...
					<div class="col-12 text-right">
						<button type="button" class="btn btn-alt-primary" id="import-table-lisensi">Import</button>
						<!-- create whitespace -->
