     ...
     <div class="content">
         ...
         <div class="block">
             <div class="block-header block-header-default">
                 <h3 class="block-title">Document IK<small></small></h3>
             </div>
                     ...
                     <tbody>
                         ...
                         <tr>
                             ...
                             <td class="d-none d-sm-table-cell" align="center">
                                 <a href="<?= base_url('Unggah/downloadIK/' . $row->id_ik) ?>" class="btn btn-success"
                                     title="Download Document">
                                     <i class="fa fa-download"></i>
                                 </a>
				<?php if($this->session->userdata('akses') == 5){ ?>
                                 <a href="<?= base_url('Unggah/deleteIKById/' . $row->id_ik) ?>" class="btn btn-danger"
                                     title="Delete Document" onclick="return confirm('Yakin Akan Menghapus Document?')">
