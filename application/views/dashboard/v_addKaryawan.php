    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Tambah Data Diri Karyawan<small></small></h3>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <div class="row col-sm-10 justify-content-center mt-8">
                                    <form id="demo-form" method="POST" action="<?= base_url('loadKar');?>" enctype="multipart/form-data">
                                        <div class="container">
                                            <div class="row">
                                                <label for="nik">NIK <span>*</span></label>
                                                <input id="nik" class="form-control" type="number" name="nik" required/>

                                                <label for="nm_karyawan">Nama Karyawan<span>*</span></label>
                                                <input type="text" id="nm_karyawan" class="form-control" name="nm_karyawan" required/>
