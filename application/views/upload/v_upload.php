                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <div class="row col-sm-10 justify-content-center mt-8">
                                    <form id="demo-form" method="POST" action="<?= base_url('prosesUpload');?>" enctype="multipart/form-data">
                                        <div class="container">
                                            <div class="row">
                                                <label for="kd_manual">Kode Document * :</label>
                                                <input type="text" id="kd_manual" class="form-control" name="kd_manual" value="<?= $kd_manual?>" readonly/>

                                                <label for="judul_manual">Nomor Document * :</label>
                                                <input type="text" id="no_manual" class="form-control" name="no_manual" required/>

                                                <label for="judul_manual">Nama Document * :</label>
                                                <input type="text" id="judul_manual" class="form-control" name="judul_manual" required/>

                                                <label for="berkas">Berkas * :</label>
                                                <input type="file" id="berkas" class="form-control" name="berkas" required />

                                                <label for="keterangan_manual">Keterangan * :</label>
                                                <textarea id="keterangan_manual" required="required" class="form-control" name="keterangan_manual"></textarea>
                                            </div>
                                        </div>
