 	...
 	<div class="content">
 		...
 		<div class="block">
 			<div class="block-header block-header-default">
 				<h3 class="block-title">Dokumen FORM<small></small></h3>
 			</div>
 					...
 					<tbody>
                        <?php
                            ...
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell"><?= $row->kd_form?></td>
                                <td class="d-none d-sm-table-cell"><?= $row->no_form?></td>
                                <td class="d-none d-sm-table-cell"><?= $row->judul_form?></td>
                                <td class="d-none d-sm-table-cell"><?= $row->keterangan_form?></td>
                                <td class="d-none d-sm-table-cell">
                                    <a href="<?= base_url('Unggah/downloadFORM/'.$row->id_form)?>" class="btn btn-app">
