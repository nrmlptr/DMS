    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                ...
                <a class="close-link" href="<?= base_url('viewShift')?>"><i class="fa fa-close"></i></a>
            </div>
                            ...
                            <div class="x_content">
                                ...
                                <div class="row col-sm-10 justify-content-center mt-8">
                                    <?php
                                        ...
                                        // var_dump($nik);die;
                                    ?>
                                    <form id="demo-form" method="POST" action="<?= base_url('loadEdSh');?>" enctype="multipart/form-data">
                                        <div class="container">
                                            <div class="row">
                                                <label for="nik">Nama Shift <span>*</span></label>
                                                <input class="form-control" type="text" name="nm_shift" value="<?= $nm_shift?>"/>
                                                <input type="hidden" name="id_shift" value="<?php echo $id_shift?>">

                                                <label for="nm_karyawan">Waktu Shift<span>*</span></label>
                                                <input class="form-control" class='optional' name="waktu_shift" type="text" value="<?= $waktu_shift?>"/>
                                            </div>
