...
<main id="main-container" style="min-height: 2130px;">
    ...
    <div class="content">
        <h2 class="content-heading">Dokumen Riksa Uji - EHS Dept</h2>

        <!-- Dynamic Table Full -->
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">Edit Expired Dokumen Riksa Uji<small></small></h3>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <div class="row col-sm-10 justify-content-center mt-8">
                                    ...
                                    ?>
                                    <form id="demo-form" method="POST" action="<?= base_url('loadEd');?>" enctype="multipart/form-data">
                                        <div class="container">
                                            <div class="row">
                                                <label for="expired_date">Expired Doc<span>*</span></label>
                                                <input class="form-control" type="date" name="expired_date" value="<?= $ujiriksa['expired_date']?>"/>
                                                <input type="hidden" name="id_document" value="<?php echo $ujiriksa['id_document']?>">
                                            </div>
