     ...
     <div class="content">
         ...
         <div class="block">
             <div class="block-header block-header-default">
                 <h3 class="block-title">Document Manual<small></small></h3>
             </div>
                 ...
                 <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                     ...
                     <tbody>
                         <?php
							...
							foreach ($manual->result() as $row) { ?>
                         <tr>
                             <td class="d-none d-sm-table-cell"><?= $loop++ ?></td>
                             <td class="d-none d-sm-table-cell"><?= $row->kd_manual ?></td>
                             <td class="d-none d-sm-table-cell"><?= $row->no_manual ?></td>
                             <td class="d-none d-sm-table-cell"><?= $row->judul_manual ?></td>
                             <td class="d-none d-sm-table-cell"><?= $row->keterangan_manual ?></td>
                             <td class="d-none d-sm-table-cell" align="center">
                                 <a href="<?= base_url('Unggah/download/' . $row->id_manual) ?>" class="btn btn-success"
                                     title="Download Document">
                                     <i class="fa fa-download"></i>
                                 </a>
                                 <a href="<?= base_url('Unggah/deleteManById/' . $row->id_manual) ?>"
